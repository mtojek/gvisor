...
type Context interface {
	...
	// Relax is called before the task goroutine that owns this context blocks,
	// indicating that the context should release temporary resources. It is also
	// called before the MemoryManager passed to Switch() changes due to
	// application execve(2).
	Relax()
